...
import com.idealbank.accounts.constants.AccountsConstants;
...
@Tag(
        name = "CRUD REST APIs for Accounts in IdealBank",
        description = "CRUD REST APIs in IdealBank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
@Validated
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer &  Account inside IdealBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
